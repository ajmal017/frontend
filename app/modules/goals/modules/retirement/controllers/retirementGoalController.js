(function(){
	...
	angular
		...
		retirementGoalsController.$inject = ['$scope','$rootScope','$route','$location','retirementGoalsService']
		function retirementGoalsController($scope,$rootScope,$route,$location,retirementGoalsService){
			$scope.retirement = {};
